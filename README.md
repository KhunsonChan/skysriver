...
![&#x5929;&#x5E55;&#x7531;&#x56DB;&#x4E2A;&#x4E3B;&#x8981;&#x6A21;&#x5757;&#x7EC4;&#x6210;](.gitbook/assets/image%20%28106%29.png)
...
四个模块**相互独立**，可按需接入；当接入全部模块时，可实现数据互通，实现真正一站式运营。

## 2、主体

类似微信主体的一个抽象概念，一个天幕账号可以创建多个主体，建议一个公司下的游戏项目放在同一个主体内进行管理。
...
我们强烈建议您添加如下微信号，让我们为您从天幕的了解、接入、使用提供全程的服务和支持
