...
* [技术指南](dev-guide/README.md)
  ...
  * [在游戏中创建广告位](dev-guide/create-ad-position/README.md)
    * [使用createFlow渲染](dev-guide/create-ad-position/createflow.md)
    * [渲染浮动窗广告](dev-guide/create-ad-position/icon.md)
    * [渲染猜你喜欢广告](dev-guide/create-ad-position/cai-ni-xi-huan.md)
    * [获取广告位开启状态](dev-guide/create-ad-position/get-ad-position-status.md)
    * [获取广告位id对应配置](dev-guide/create-ad-position/get-ad-position-config.md)
    * [点击推广创意后跳转到落地页](dev-guide/create-ad-position/landing.md)
