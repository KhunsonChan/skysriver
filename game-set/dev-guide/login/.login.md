...
请注意：若该接口返回值中无头像、昵称等微信信息，请调用 [updateUserinfo](.updateuserinfo.md) 更新用户信息。
...
| nick\_name | string | 用户的微信昵称，为空时需要调用 [`updateUserinfo`](.updateuserinfo.md) 获取 |
| nick\_name | string | 用户的微信昵称，为空时需要调用 [`updateUserinfo`](.updateuserinfo.md) 获取 |
| avatar\_url | string | 用户的微信头像，为空时需要调用 [`updateUserinfo`](.updateuserinfo.md) 获取 |
